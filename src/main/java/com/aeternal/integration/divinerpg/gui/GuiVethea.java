...
public class GuiVethea extends GuiCore<ContainerSolarPanels> {


    public final TileVetheaSolarPanel tileentity;
    private ResourceLocation res;

    public GuiVethea(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileVetheaSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockVetheaSolarPanel.name");
