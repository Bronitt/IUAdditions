...
public class GuiMortum extends GuiCore<ContainerSolarPanels> {
    ...
    public GuiMortum(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileMortumSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockMortumSolarPanel.name");
