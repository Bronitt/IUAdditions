...
public class GuiWildwood extends GuiCore<ContainerSolarPanels> {


    public final TileWildwoodSolarPanel tileentity;
    private ResourceLocation res;

    public GuiWildwood(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileWildwoodSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockWildwoodSolarPanel.name");
