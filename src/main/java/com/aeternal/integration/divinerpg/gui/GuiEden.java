...
public class GuiEden extends GuiCore<ContainerSolarPanels> {


    public final TileEdenSolarPanel tileentity;
    private ResourceLocation res;

    public GuiEden(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileEdenSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockEdenSolarPanel.name");
