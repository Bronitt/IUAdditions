...
public class GuiApalachia extends GuiCore<ContainerSolarPanels> {


    public final TileApalachiaSolarPanel tileentity;
    private ResourceLocation res;

    public GuiApalachia(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileApalachiaSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockApalachiaSolarPanel.name");
