...
public class GuiCrossdim extends GuiCore<ContainerSolarPanels> {


    public final TileCrossDimentionalSolarPanel tileentity;
    private ResourceLocation res;

    public GuiCrossdim(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileCrossDimentionalSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockCrossDimSolarPanel.name");
