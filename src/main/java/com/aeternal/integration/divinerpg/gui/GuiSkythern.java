...
public class GuiSkythern extends GuiCore<ContainerSolarPanels> {


    public final TileSkythernSolarPanel tileentity;
    private ResourceLocation res;

    public GuiSkythern(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileSkythernSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockSkythernSolarPanel.name");
