...
public class GuiArcana extends GuiCore<ContainerSolarPanels> {


    public final TileArcanaSolarPanel tileentity;
    private ResourceLocation res;

    public GuiArcana(ContainerSolarPanels container) {
        super(container);
        this.tileentity = (TileArcanaSolarPanel) container.tileentity;
        this.xSize = 194;
        this.ySize = 238;
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        String formatPanelName = Localization.translate("blockArcanaSolarPanel.name");
