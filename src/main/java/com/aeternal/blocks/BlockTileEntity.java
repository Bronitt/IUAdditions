...
import com.aeternal.api.IMultiTileBlock;
import com.aeternal.blocks.mechanism.TileBlockCreator;
import com.aeternal.items.block.ItemBlockTileEntity;
...
public final class BlockTileEntity extends BlockBase implements IWrenchable, ITileEntityProvider {
    ...
    public static BlockTileEntity create(String name, ResourceLocation identifier, final TileBlockCreator.InfoAboutTile<?> value) {
    ...
    public void registerModels() {
        StateMapperIUA stateInvalid = new StateMapperIUA(ModUtils.getName(IUItem.invalid));
        ...
        ModelLoader.setCustomStateMapper(this, block -> block.getBlockState().getValidStates().stream()
                .collect(Collectors.toMap(
                        ...
                        state -> {
                            ...
                            StateMapperIUA stateMapper = new StateMapperIUA(stateProperty.teBlock.getIdentifier());
        ...
        ModelLoader.setCustomMeshDefinition(this.item, stack -> {
            ...
            if (teBlock == null && !(teInfo.getListBlock().get(0) instanceof IItemIgnoringNull)) {
                ...
                StateMapperIUA stateMapper = new StateMapperIUA(teBlock.getIdentifier());
                ...
                try {
                    ...
                    if (state != null) {
                        ...
                        stateMapper = new StateMapperIUA( ModUtils.getName(IUItem.invalid));
                    ...
                    final StateMapperIUA stateMapper = new StateMapperIUA(ModUtils.getName(IUItem.invalid));
                    return stateMapper.getModelResourceLocation(
                            this.blockState
                                    .getBaseState()
                                    .withProperty(this.typeProperty, TypeProperty.invalid)
        ...
        for (TypeProperty.StatesBlocks statesBlocks : this.typeProperty.getAllStates()) {
            if (statesBlocks.hasItem()) {
                ...
                if (model == null) {
                    ...
                    StateMapperIUA stateMapper = new StateMapperIUA(statesBlocks.getIdentifier());
    ...
    public IBlockState getExtendedState(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        return (te == null ? state : getExtendedState((TileEntityBlockStateContainer.PropertiesStateInstance)state));
    }
    @SideOnly(Side.CLIENT)
